...
public class Board extends Observable {
    ...
    private void clearLines() {
        ...
        //if minimum 1 line is cleared, send update
        if (sendUpdate) {
            setChanged();
            notifyObservers();
        }
     ...
     * @param theBoardWidthInBlocks int width in blocks
     * @param theBoardHeightInBlocks int height in blocks
     */
    public void loadGame(final Piece theCurrentPiece,
        ...
        newGame(theBoardWidthInBlocks, theBoardHeightInBlocks, null);
