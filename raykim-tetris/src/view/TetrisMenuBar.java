...
public class TetrisMenuBar extends JMenuBar {
    ...
    /**
     * Constant containing the string "Reverse Tetris Mode".
     */
    public static final String REVERSE_TETRIS_MODE = "Reverse Tetris Mode";
    ...
    public static final String[][][] JMENU_STRINGS = {
        {{"File", null, ZERO, null}, {"New Game", null, ZERO, null},
            ...
            {SEPARATOR}, {"End Game", null, ZERO, null}}, 
        ...
        {{"Game", null, ZERO, null}, {"View Replay", null, ZERO, null}, {SEPARATOR},
            ...
            {SEPARATOR}, {REVERSE_TETRIS_MODE, J_CHECKBOX_MENUITEM, ZERO, null}}, 
    ...
    private void createBlockRowColumnJSlider(final int theBoardWidthInBlocks, 
        ...
        for (final Map.Entry<String, Integer> nameToDefault 
            ...
            final JSlider sizeInBlocksSlider = new JSlider(JSlider.HORIZONTAL, 
                                                            BLOCK_ROW_COL_MIN, 
                                                            BLOCK_ROW_COL_MAX, 
                                                            nameToDefault.getValue());
            
            //set tick incrementation
            sizeInBlocksSlider.setMajorTickSpacing(MAJOR_TICK_INTERVALS);
            sizeInBlocksSlider.setMinorTickSpacing(MINOR_TICK_INTERVALS);
            sizeInBlocksSlider.setPaintTicks(true);
            sizeInBlocksSlider.setSnapToTicks(true);
            sizeInBlocksSlider.setPaintLabels(true);
            
            
            
            //add change listener
            sizeInBlocksSlider.addPropertyChangeListener(new PropertyChangeListener() {
            ...
            ((JMenu) myMenuMap.get(nameToDefault.getKey())).add(sizeInBlocksSlider);
        } //end of for
    ...
    //setters
    /**
     * This method sets the reverse tetris JCheckBoxMenuItem as checked or unchecked.
     * @param theBoolean true sets the mode on, false disables it
     */
    public void setReverseTetrisCheckedInMenuBar(final boolean theBoolean) {
        ((JCheckBoxMenuItem) myMenuMap.get(REVERSE_TETRIS_MODE)).setSelected(theBoolean);
